  ...
  const handleOnChangeLogoCheckbox = async (event) => {
    try {
      ...
      if (response.data.status === 'success') {
        ...
        showNotification(
          'success',
          "Wohooo champ! You've added to use your logo as a part of your gifs!"
        );
      }
    } catch (error) {
      ...
      showNotification(
        'error',
        'Ohh noo! There was an issue to include your logo in your gifs!'
      );
    }
  };
      ...
      <Box className="profile-info">
        ...
        <Box className="email-details">
          <div className="text">
            ...
            {!isMobile && (
              <Button
                name="edit-email"
                onClick={handleOnClickChangeEmailButton}
              >
                Edit Email
              </Button>
            )}
          ...
          <div className="email">
            {!isMobile && (
              <Tag
                ...
                label={isActive ? 'Verified' : 'Not verified'}
              />
            )}
            {isMobile && (
              <Button
            ...
            <TextField value={user?.email} className="email" disabled />
            {!isActive && !isMobile && (
              <Button
                className="verify-email-btn"
                onClick={handleOnResendEmailVerification}
              >
                verify
              </Button>
            )}
        ...
        <Box className="resolution-details">
          ...
          <div className="resolution">
            {isMobile && (
              <Button name="edit-email" onClick={() => setShowOptions(true)}>
                Edit
              </Button>
            )}
            <ResolutionSelect
              onChange={handleResolutionSizeChange}
        ...
        {userLogoSrc && (
          <Box className="checkbox">
            ...
            <Checkbox
              onChange={handleOnChangeLogoCheckbox}
              checked={logoChecked}
            />
          </Box>
        )}
